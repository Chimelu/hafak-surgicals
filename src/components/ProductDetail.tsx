...
import { ArrowLeft, Star, Shield, Truck, CheckCircle } from 'lucide-react'
                ...
                <div className="border-t border-gray-200 pt-6 mb-6">
                  ...
                  <div className="w-full">
                    <button 
                      ...
                      className="w-full bg-green-600 text-white py-3 px-4 sm:px-6 rounded-lg font-semibold hover:bg-green-700 transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
                    >
